...
After pseudo labeling, we will get five well-trained models in five experiment(exp) folders: 
...
The weight will be saved in `dark/best.pyth` under every exp folder.
