...
parser.add_argument('--gen_label_list_path', type=str, default="/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/data/train_unlabel.csv")
...
parser.add_argument('--gen_label_pkl_path_slowfast_best', type=str, default="/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/exp_pseudo_arid_stage3/uniformer_b32_k600_ce/real_unlabelx32x224x1x1.pkl")
...
pred,idx_x,prob = get_pseudo_label(idx,ssv2_best_probs,uni_best_probs,mvit_best_probs,slowfast_best_probs)

prob = ssv2_best_probs
pred = prob.argmax(1)
...
real_csv_list = []
with open('/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/data/real_unlabel.csv')as f:
    f_csv = csv.reader(f)
