...
parser.add_argument('--path_pseudo_label', type=str, default="/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/data/pseudo/stage1_all_prob.csv")
