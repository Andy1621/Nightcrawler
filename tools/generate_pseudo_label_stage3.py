...
parser.add_argument('--gen_label_pkl_path_ssv2_best', type=str, default="/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/exp_pseudo_arid_stage2/uniformer_b32_ssv2_ce/real_unlabelx32x224x1x1.pkl")
...
parser.add_argument('--gen_label_pkl_path_uni_best', type=str, default="/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/exp_pseudo_arid_stage2/uniformer_b32_k600_ce/real_unlabelx32x224x1x1.pkl")
...
parser.add_argument('--gen_label_pkl_path_mvit_best', type=str, default="/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/exp_pseudo_arid_stage2/mvit_b32_k600_dp0.3_ce/real_unlabelx32x224x1x1.pkl")
parser.add_argument('--gen_label_pkl_path_slowfast_best', type=str, default="/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/exp_pseudo_arid_stage2/uniformer_b32_k600_ce/real_unlabelx32x224x1x1.pkl")
parser.add_argument('--path_pseudo_label', type=str, default="/mnt/lustre/likunchang.vendor/sjj/ug2_uniformer_competition/data/pseudo/8712_0.90_prob_stage3.csv")
