...
def test(cfg):
    ...
    test_loader = loader.construct_loader(cfg, cfg.TEST.DATA_SELECT, decording="decord_GIC")
    ...
    file_name = f'{cfg.TEST.DATA_SELECT}x{cfg.DATA.NUM_FRAMES}x{cfg.DATA.TEST_CROP_SIZE}x{cfg.TEST.NUM_ENSEMBLE_VIEWS}x{cfg.TEST.NUM_SPATIAL_CROPS}.pkl'
