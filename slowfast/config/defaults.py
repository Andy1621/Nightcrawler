...
_C.MODEL.PSEUDO_LOSS_FUNC = ""
_C.MODEL.SOFT_T = 1

# Model architectures that has one single pathway.
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "uniformer", "vip", "swin", "sf"]
...
_C.SF.PRETRAIN_NAME = "SlowFast-ResNet101-8x8"

_C.SF.DROPOUT_RATE = 0.2

_C.SF.FROZEN_BN = False

_C.SF.NONLOCAL = CfgNode()

_C.SF.NONLOCAL.FROZEN_BN =False
...
# _C.SWIN.pretrained = None
# _C.SWIN.pretrained2d = False
# _C.SWIN.patch_size = (2,4,4)
# _C.SWIN.in_chans = 3
# _C.SWIN.embed_dim =96 #need change for small large 
# _C.SWIN.depths = [2, 2, 6, 2]   #need change for small large 
# _C.SWIN.num_heads = [3, 6, 12, 24] #need change for small large 
...
# _C.SWIN.drop_path_rate = 0.3
# _C.SWIN.norm_layer = 0.2 
# _C.SWIN.patch_norm = False
# _C.SWIN.frozen_stages = -1
# _C.SWIN.use_checkpoint = False
# _C.SWIN.in_channels = 768 #need change for small large 
# _C.SWIN.num_classes = 400
# _C.SWIN.spatial_type = 'avg'
# _C.SWIN.dropout_ratio = 0.5
# _C.SWIN.init_std = 0.01
...
# special label lift for binary class
_C.DATA.SPECIAL_LABEL_LIST = [5, 9]
